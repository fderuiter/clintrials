...
def _build_registry():
            ...
            for i, line in enumerate(lines):
                ...
                if '(' in line and '):' in line:
                    ...
                    if i + 1 < len(lines):
                        ...
                        if next_line and not ('(' in next_line and '):' in next_line) and not next_line.startswith(('Returns:', 'Args:')):
                            desc += ' ' + next_line
    ...
    registry["run_simulation_button"] = "Run a Monte Carlo simulation to estimate win-ratio power."
