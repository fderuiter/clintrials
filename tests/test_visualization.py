...
def test_plot_crm_simulation_recommendation():  # type: ignore[no-untyped-def]
    ...
    fig = plot_crm_simulation_recommendation(summary_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)

    empty_df = pd.DataFrame()
    fig = plot_crm_simulation_recommendation(empty_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)
...
def test_plot_bivariate_simulation_recommendation():  # type: ignore
    ...
    fig = plot_bivariate_simulation_recommendation(summary_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)

    empty_df = pd.DataFrame()
    fig = plot_bivariate_simulation_recommendation(empty_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)
...
def test_plot_efftox_simulation_acceptability():  # type: ignore[no-untyped-def]
    ...
    fig = plot_efftox_simulation_acceptability(summary_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)

    empty_df = pd.DataFrame()
    fig = plot_efftox_simulation_acceptability(empty_df)  # type: ignore[no-untyped-call]
    assert isinstance(fig, go.Figure)
