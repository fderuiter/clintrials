...
def test_find_notebook_files(tmp_path):
...
def test_notebook_ast_visitor_private_imports():
...
def test_load_public_elements(tmp_path):
    manifest_data = {
        "clintrials.core": {
            "Protocol": {
                "type": "class",
...
def test_audit_single_notebook(tmp_path):
