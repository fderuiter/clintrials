...
class CustomSingleEndpointTrial(DoseFindingTrial):
    ...
    def _calculate_next_dose(self, **kwargs: Any) -> int:
        ...
        return min(self._first_dose + len(self.doses()) * multiplier, self.num_doses)
...
def test_custom_single_endpoint_trial_flow():
    # Initialize
...
def test_custom_dual_endpoint_trial_flow():
    # Initialize
